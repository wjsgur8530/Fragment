...
public class waterTankClean_3 extends Fragment {
    private View view;
    private String result;
    private Button btn_move;
    Integer water_Tank_Clean;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_3_watertankclean, container, false);

        RadioGroup rdiog_3_water_tank_clean = (RadioGroup) view.findViewById(R.id.water_Tank_Clean_rdogrp3);
...
//        }
        ...
        btn_move.setOnClickListener(new View.OnClickListener() { //fragment1로 이동
            ...
            public void onClick(View v) {
                ...
                bundle.putString("submit", water_tank_clean); //id, content 마지막 페이지로 데이터 전달
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                waterTankTime_4 watertanktime_4 = new waterTankTime_4();
                watertanktime_4.setArguments(bundle);
                transaction.replace(R.id.framelayout, watertanktime_4); //프레임레이아웃은 가만히 있는 상태에서 프래그먼트만 교체, (frame, 교체될 fragment)
